...
import object_detection.protos.top_k_anchor_matcher_pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='object_detection/protos/matcher.proto',
  package='object_detection.protos',
  serialized_pb=_b('\n%object_detection/protos/matcher.proto\x12\x17object_detection.protos\x1a,object_detection/protos/argmax_matcher.proto\x1a/object_detection/protos/bipartite_matcher.proto\x1a\x32object_detection/protos/top_k_anchor_matcher.proto\"\xf0\x01\n\x07Matcher\x12@\n\x0e\x61rgmax_matcher\x18\x01 \x01(\x0b\x32&.object_detection.protos.ArgMaxMatcherH\x00\x12\x46\n\x11\x62ipartite_matcher\x18\x02 \x01(\x0b\x32).object_detection.protos.BipartiteMatcherH\x00\x12J\n\x14top_k_anchor_matcher\x18\x03 \x01(\x0b\x32*.object_detection.protos.TopKAnchorMatcherH\x00\x42\x0f\n\rmatcher_oneof')
  ,
  dependencies=[object_detection.protos.argmax_matcher_pb2.DESCRIPTOR,object_detection.protos.bipartite_matcher_pb2.DESCRIPTOR,object_detection.protos.top_k_anchor_matcher_pb2.DESCRIPTOR,])
...
_MATCHER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='top_k_anchor_matcher', full_name='object_detection.protos.Matcher.top_k_anchor_matcher', index=2,
...
_MATCHER.fields_by_name['top_k_anchor_matcher'].message_type = object_detection.protos.top_k_anchor_matcher_pb2._TOPKANCHORMATCHER
...
_MATCHER.oneofs_by_name['matcher_oneof'].fields.append(
  _MATCHER.fields_by_name['top_k_anchor_matcher'])
_MATCHER.fields_by_name['top_k_anchor_matcher'].containing_oneof = _MATCHER.oneofs_by_name['matcher_oneof']
